...
import {
  deleteCategory,
  getGunCategoryMasterList,
  updateGunCategoryStatus,
} from "../../../api/Gun/gunCategoryMaster";
      ...
      <div className="row">
        <div className="col-12">
          <div className="d-flex justify-content-between align-items-center mt-3 mt-xxl-4 mb-3">
            ...
            {categoryMasterPermission.canCreate && (
              <button
                type="button"
          ...
          >
            ...
            >
              ...
              >
                {hasAction(categoryMasterPermission) && (
                  <GridColumn
                ...
                <GridColumn
                  ...
                  width={getWidth("accessoryCategory")}
                  cells={{
                    headerCell: (props) => (
                      <FilterHeaderCell
                        {...props}
                ...
                <GridColumn
                  ...
                  width={getWidth("parentCategoryName")}
